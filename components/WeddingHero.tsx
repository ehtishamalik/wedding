...
const WeddingHero = () => {
  ...
  const brideOffset = useMemo(() => {
    ...
    return (-maxOffset * (1 - moveProgress)).toFixed(2);
    ...
    <section className="relative min-h-screen w-full overflow-hidden bg-background">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8">
        ...
        <div className="relative w-full max-w-4xl flex items-end justify-center mb-8 md:mb-12">
          {/* Groom - facing right */}
          <div
            className="z-10 transition-transform translate-y-5 duration-1000 ease-out"
            style={{
              transform: `translateX(${Number(brideOffset) + 30}%)`,
            }}
          >
            <Image
              src="/bride.png"
          ...
          <div
            ...
            style={{
              transform: `translateX(${Number(groomOffset) - 30}%)`,
            }}
          >
            <Image
              src="/groom.png"
